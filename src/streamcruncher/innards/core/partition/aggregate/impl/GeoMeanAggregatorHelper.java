...
/*
 * Author: Ashwin Jayaprakash Date: Oct 10, 2006 Time: 10:47:18 PM
 */

public class GeoMeanAggregatorHelper extends AbstractAggregatorHelper {
    public GeoMeanAggregatorHelper() {
        super(Aggregator.GEOMEAN.name(), GeoMeanAggregator.class);
    }
    ...
    public String getAggregatedColumnDDLFragment(DBName dbName, String[] params,
        ...
        return columnDDLHelper.getDDLFragment(Aggregator.GEOMEAN, dbName, params,
                columnNamesAndTypes);
    }
}
