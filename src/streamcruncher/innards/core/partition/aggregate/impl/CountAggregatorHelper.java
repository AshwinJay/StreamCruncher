...
public class CountAggregatorHelper extends AbstractAggregatorHelper {
    public CountAggregatorHelper() {
        super(Aggregator.COUNT.name(), CountAggregator.class);
    }
    ...
    public String getAggregatedColumnDDLFragment(DBName dbName, String[] params,
        ...
        return columnDDLHelper
                .getDDLFragment(Aggregator.COUNT, dbName, params, columnNamesAndTypes);
    }
}
