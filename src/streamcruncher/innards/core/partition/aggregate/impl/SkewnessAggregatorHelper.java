...
/*
 * Author: Ashwin Jayaprakash Date: Oct 10, 2006 Time: 11:07:26 PM
 */

public class SkewnessAggregatorHelper extends AbstractAggregatorHelper {
    public SkewnessAggregatorHelper() {
        super(Aggregator.SKEWNESS.name(), SkewnessAggregator.class);
    }
    ...
    public String getAggregatedColumnDDLFragment(DBName dbName, String[] params,
        ...
        return columnDDLHelper.getDDLFragment(Aggregator.SKEWNESS, dbName, params,
                columnNamesAndTypes);
    }
}
