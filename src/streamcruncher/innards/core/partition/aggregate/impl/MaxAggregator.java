...
/*
 * Author: Ashwin Jayaprakash Date: Oct 9, 2006 Time: 10:02:33 PM
 */

public class MaxAggregator extends GenericSingleSrcColumnAggregator<Comparable> {
    private static final long serialVersionUID = 1L;

    @Override
    protected Comparable fetchAggregatedValue() {
        return valuesAndCounts.lastKey();
    }
