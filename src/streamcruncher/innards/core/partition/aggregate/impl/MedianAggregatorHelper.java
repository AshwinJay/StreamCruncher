...
/*
 * Author: Ashwin Jayaprakash Date: Oct 10, 2006 Time: 11:06:25 PM
 */

public class MedianAggregatorHelper extends AbstractAggregatorHelper {
    public MedianAggregatorHelper() {
        super(Aggregator.MEDIAN.name(), MedianAggregator.class);
    }
    ...
    public String getAggregatedColumnDDLFragment(DBName dbName, String[] params,
        ...
        return columnDDLHelper.getDDLFragment(Aggregator.MEDIAN, dbName, params,
                columnNamesAndTypes);
    }
}
