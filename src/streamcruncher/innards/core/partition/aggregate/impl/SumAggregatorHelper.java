...
/*
 * Author: Ashwin Jayaprakash Date: Oct 10, 2006 Time: 11:09:44 PM
 */

public class SumAggregatorHelper extends AbstractAggregatorHelper {
    public SumAggregatorHelper() {
        super(Aggregator.SUM.name(), SumAggregator.class);
    }
    ...
    public String getAggregatedColumnDDLFragment(DBName dbName, String[] params,
        ...
        return columnDDLHelper.getDDLFragment(Aggregator.SUM, dbName, params, columnNamesAndTypes);
    }
}
