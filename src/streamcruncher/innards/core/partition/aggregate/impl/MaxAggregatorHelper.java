...
/*
 * Author: Ashwin Jayaprakash Date: Oct 10, 2006 Time: 11:05:10 PM
 */

public class MaxAggregatorHelper extends AbstractAggregatorHelper {
    public MaxAggregatorHelper() {
        super(Aggregator.MAX.name(), MaxAggregator.class);
    }
    ...
    public String getAggregatedColumnDDLFragment(DBName dbName, String[] params,
        ...
        return columnDDLHelper.getDDLFragment(Aggregator.MAX, dbName, params, columnNamesAndTypes);
    }
}
