...
/*
 * Author: Ashwin Jayaprakash Date: Oct 10, 2006 Time: 11:10:36 PM
 */

public class SumSqAggregatorHelper extends AbstractAggregatorHelper {
    public SumSqAggregatorHelper() {
        super(Aggregator.SUMSQ.name(), SumSqAggregator.class);
    }
    ...
    public String getAggregatedColumnDDLFragment(DBName dbName, String[] params,
        ...
        return columnDDLHelper
                .getDDLFragment(Aggregator.SUMSQ, dbName, params, columnNamesAndTypes);
    }
}
