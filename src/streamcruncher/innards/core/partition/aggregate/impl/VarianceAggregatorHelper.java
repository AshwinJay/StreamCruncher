...
/*
 * Author: Ashwin Jayaprakash Date: Oct 10, 2006 Time: 11:11:55 PM
 */

public class VarianceAggregatorHelper extends AbstractAggregatorHelper {
    public VarianceAggregatorHelper() {
        super(Aggregator.VARIANCE.name(), VarianceAggregator.class);
    }
    ...
    public String getAggregatedColumnDDLFragment(DBName dbName, String[] params,
        ...
        return columnDDLHelper.getDDLFragment(Aggregator.VARIANCE, dbName, params,
                columnNamesAndTypes);
    }
}
