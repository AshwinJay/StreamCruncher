...
/*
 * Author: Ashwin Jayaprakash Date: Oct 10, 2006 Time: 10:50:54 PM
 */

public class MinAggregatorHelper extends AbstractAggregatorHelper {
    public MinAggregatorHelper() {
        super(Aggregator.MIN.name(), MinAggregator.class);
    }
    ...
    public String getAggregatedColumnDDLFragment(DBName dbName, String[] params,
        ...
        return columnDDLHelper.getDDLFragment(Aggregator.MIN, dbName, params, columnNamesAndTypes);
    }
}
