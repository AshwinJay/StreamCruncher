...
/*
 * Author: Ashwin Jayaprakash Date: Oct 10, 2006 Time: 11:08:49 PM
 */

public class StdDevAggregatorHelper extends AbstractAggregatorHelper {
    public StdDevAggregatorHelper() {
        super(Aggregator.STDDEV.name(), StdDevAggregator.class);
    }
    ...
    public String getAggregatedColumnDDLFragment(DBName dbName, String[] params,
        ...
        return columnDDLHelper.getDDLFragment(Aggregator.STDDEV, dbName, params,
                columnNamesAndTypes);
    }
}
