...
public class SolidTableSpec extends TableSpec {
    private static final long serialVersionUID = 1L;

    public SolidTableSpec(String schema, String name, RowSpec rowSpec, IndexSpec[] indexSpecs,
    ...
    public String constructCreateCommand() {
        return super.constructCreateCommand() + " STORE MEMORY";
    }
}
