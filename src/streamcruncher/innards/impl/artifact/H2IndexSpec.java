...
public class H2IndexSpec extends IndexSpec {
     ...
     * @param columnName
     * @param ascending
     *            doc 'ascending' is ignored.
     */
    public H2IndexSpec(String schema, String name, String tableName, boolean unique,
    ...
    public String constructCreateCommand() {
        String ddl = "create " + (unique ? "unique hash" : "") + " index " + getFQN() + " on "
                + getTableFQN() + "(";
