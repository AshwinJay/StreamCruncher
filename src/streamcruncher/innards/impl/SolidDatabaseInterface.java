...
import streamcruncher.innards.impl.query.SolidDDLHelper;
import streamcruncher.innards.impl.query.SolidParser;
...
public class SolidDatabaseInterface extends DatabaseInterface {
    @Override
    public Class<? extends Parser> getParser() {
        return SolidParser.class;
    }
