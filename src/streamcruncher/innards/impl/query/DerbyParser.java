...
public class DerbyParser extends AbstractParser {
    public DerbyParser(ParserParameters parserParameters) throws QueryParseException {
        super(parserParameters);
    }

    @Override
    protected TableSpec customizeResultTableSpec(RowSpec rowSpec, IndexSpec[] indexSpecs) {
        rowSpec.getColumnNativeTypes()[Constants.ID_COLUMN_POS] = "bigint not null primary key generated always as identity";
