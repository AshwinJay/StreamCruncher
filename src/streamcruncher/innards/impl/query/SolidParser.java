...
import streamcruncher.innards.impl.artifact.SolidTableSpec;
...
public class SolidParser extends AbstractParser {
    public SolidParser(ParserParameters parserParameters) throws QueryParseException {
    ...
    protected TableSpec createTableSpec(String schema, String name, RowSpec rowSpec,
        ...
        return new SolidTableSpec(schema, name, rowSpec, indexSpecs, otherClauses, partitioned,
                virtual);
    }
    ...
    protected TableSpec createUnpartitionedTableSpec(String schema, String name, RowSpec rowSpec,
        ...
        return new SolidTableSpec(schema, name, rowSpec, indexSpecs, otherClauses);
    }
