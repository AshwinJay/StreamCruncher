...
public class OracleDDLHelper extends AbstractAggregatedColumnDDLHelper implements DDLHelper {
    protected static final Map<String, String> NATIVE_TO_JAVA_TYPES = new HashMap<String, String>() {
        {
            ...
            put("double precision", java.lang.Double.class.getName());
            put("number", java.lang.Long.class.getName());
    ...
    protected static final Map<String, String> JAVA_TO_NATIVE_TYPES = new HashMap<String, String>() {
        {
            ...
            put(java.lang.Float.class.getName(), "double precision");
            put(java.lang.Double.class.getName(), "double precision");
