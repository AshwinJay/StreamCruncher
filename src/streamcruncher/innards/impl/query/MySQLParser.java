...
public class MySQLParser extends AbstractParser {
    public MySQLParser(ParserParameters parserParameters) throws QueryParseException {
        super(parserParameters);
    }

    @Override
    protected TableSpec customizeResultTableSpec(RowSpec rowSpec, IndexSpec[] indexSpecs) {
        rowSpec.getColumnNativeTypes()[Constants.ID_COLUMN_POS] = "bigint not null primary key auto_increment";
    ...
    protected TableSpec createTableSpec(String schema, String name, RowSpec rowSpec,
        ...
        return new MySQLTableSpec(schema, name, rowSpec, indexSpecs, otherClauses, partitioned,
                virtual);
    }
    ...
    protected IndexSpec createIndexSpec(String schema, String name, String tableFQN,
        ...
        return new MySQLIndexSpec(schema, name, tableFQN, unique, columnName, ascending);
    }

    @Override
    protected IndexSpec createIndexSpec(String schema, String name, String tableFQN,
            boolean unique, String[] columnNames, boolean[] ascending) {
        return new MySQLIndexSpec(schema, name, tableFQN, unique, columnNames, ascending);
    }
