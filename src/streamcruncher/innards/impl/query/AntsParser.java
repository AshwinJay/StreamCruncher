...
public class AntsParser extends AbstractParser {
    public AntsParser(ParserParameters parserParameters) throws QueryParseException {
        super(parserParameters);
    }

    @Override
    protected TableSpec customizeResultTableSpec(RowSpec rowSpec, IndexSpec[] indexSpecs) {
        rowSpec.getColumnNativeTypes()[Constants.ID_COLUMN_POS] = "bigint not null primary key identity";
    ...
    protected boolean isUniqueIndexOnResultTableReqd() {
        ...
        // todo Explicit Hash Index or default BTree Index?
        return false;
    }
    ...
    protected IndexSpec createIndexSpec(String schema, String name, String tableFQN,
        ...
        return new AntsIndexSpec(schema, name, tableFQN, unique, columnName, ascending);
    }

    @Override
    protected IndexSpec createIndexSpec(String schema, String name, String tableFQN,
            boolean unique, String[] columnNames, boolean[] ascending) {
        return new AntsIndexSpec(schema, name, tableFQN, unique, columnNames, ascending);
    }
