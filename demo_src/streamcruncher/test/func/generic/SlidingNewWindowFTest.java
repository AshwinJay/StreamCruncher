 ...
 */
public abstract class SlidingNewWindowFTest extends SlidingWindowTest {
    @Override
    ...
    protected void verify(List<BatchResult> results) {
        Assert.assertEquals(results.size(), 3, "Expected 3 batch-result sets");

        int[] resultSizes = { 10, 1, 1 };
